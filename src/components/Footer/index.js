...
function Footer() {
  return (
    <footer className="footer">
      <a href="#" target="_blank" rel="noreferrer"><img src={instagramLogo} className="footerZoom rounded-image" alt="Instagram logo."/><span className="footer-text">Instagram</span></a>
